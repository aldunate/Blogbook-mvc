...
function ($scope, articles, categories, blogAnalyzer, $stateParams, $location) {
    ...
    $scope.categories = [
        { id: "Deportes", name: "Deportes", state: false },
        { id: "Politica", name: "Politica", state: false },
        { id: "Ciencia", name: "Ciencia", state: false },
        { id: "Moda", name: "Moda", state: false },
        { id: "Cine", name: "Cine", state: false },
        { id: "Tecnologia", name: "Tecnología", state: false }];
